...
!(function(t) {
    ...
    t.exports = {
      copy: function t(e) {
        ...
        if (e && "object" == typeof e) {
          for (
            a = {}, n = [Array, Number, String, Boolean], i = 0;
            i < n.length;
            i++
          )
            e instanceof n[i] && (a = i ? new n[i](e) : new n[i]());
          for (i in (r.isDate(e) && (a = new Date(e)), e))
            Object.prototype.hasOwnProperty.apply(e, [i]) && (a[i] = t(e[i]));
        }
        return a || e;
      },
      defined: function(t) {
      ...
      return (
        (e.prototype = {
          ...
          is_changed: function(t, e, i, n) {
            ...
            return r && t && r.valueOf && t.valueOf
              ? r.valueOf() != t.valueOf()
              : r != t;
          },
          ...
          var a = [],
            ...
            o = {
              ...
              init: function() {
                ...
                var i = this;
                a.push(
                  s.attachEvent("onIdChange", function(t, e) {
                    i._itemId == t && (i._itemId = e);
                  })
                ),
                  a.push(
                    s.attachEvent("onStoreUpdated", function() {
                      n.$gantt.getState("batchUpdate").batch_update ||
                        (i.isVisible() && !s.isVisible(i._itemId) && i.hide());
                    })
                  ),
                  (this.init = function() {});
              },
              ...
              startEdit: function(t, e) {
                if ((this.isVisible() && this.save(), s.exists(t))) {
                  ...
                  !1 !== this.callEvent("onBeforeEditStart", [i]) &&
                    (this.show(i.id, i.columnName),
                    this.setValue(),
                    this.callEvent("onEditStart", [i]));
                }
              },
              isVisible: function() {
                return !(
                  !this._editor ||
                  !c.isChildOf(this._placeholder, document.body)
                );
              },
              show: function(t, i) {
              ...
              hide: function() {
                if (this._itemId) {
                  ...
                  r.onHide && r.onHide(this, this._placeholder, n),
                    ...
                    this._placeholder &&
                      (this._editor && this._editor.hide(this._placeholder),
                      (this._editor = null),
              ...
              save: function() {
                if (
                  ...
                  if (s.exists(e)) {
                    ...
                    if (
                      !1 !== this.callEvent("onBeforeSave", [o]) &&
                      ...
                      "auto" != a.map_to
                        ? ((r[i] = l),
                          "duration" == i
                            ...
                            : "end_date" == i
                              ? (r.start_date = t.calculateEndDate({
              ...
              getNextCell: function(t) {
                return this._findEditableCell(
                  n.getColumnIndex(this._columnName) + t,
                  t
                );
              },
              ...
              editNextCell: function(t) {
                ...
                if (e) {
                  ...
                  i &&
                    this.getEditorConfig(i) &&
                    this.startEdit(this._itemId, i);
              ...
              moveRow: function(e) {
                return e > 0
                  ? t.getNext(this._itemId)
                  : t.getPrev(this._itemId);
              },
  ...
  function(t, e, i) {
    ...
    (o.prototype = {
      ...
      setSize: function(t, e) {
        ...
        for (
          var i, n = this.getGridColumns(), r = 0, a = 0, s = n.length;
          a < s;
          a++
        )
          r += 1 * n[a].width;
        (!isNaN(r) && this.$config.scrollable) ||
          (r = i = this._setColumnsWidth(t + 1)),
      ...
      _setColumnsWidth: function(t, e) {
        ...
        for (
          ...
          for (s = e + 1; s < n.length; s++) {
            var f;
            if (
              ((f = n[s].width + u) == this._getColumnWidth(n[s], i, f) &&
                ((l -= u), (n[s].width = f)),
              !l)
            )
              break;
        ...
        l &&
          e > -1 &&
          ((f = n[e].width + l) == this._getColumnWidth(n[e], i, f) &&
            (n[e].width = f));
        ...
        if (t.autofit || n.length) {
          ...
          if (t.autofit)
            for (a = 0; a < r.length; a++) {
              ...
              (r[a] += d),
                (c = this._getColumnWidth(e[a], t, r[a])) != r[a] &&
                  ((d = c - r[a]), (r[a] = c)),
                (l -= d);
            }
          else if (n.length)
            for (a = 0; a < n.length; a++) {
              ...
              var c,
                h = n[a];
              (r[h] += d),
                (c = this._getColumnWidth(e[h], t, r[h])) != r[h] &&
                  ((d = c - r[h]), (r[h] = c)),
                (l -= d);
            }
      ...
      _renderGridHeader: function() {
        ...
        for (
          ...
          var m =
            ...
            p +
            "' " +
            t._waiAria.gridScaleCellAttrString(h, v) +
            " data-column-id='" +
            h.name +
            "' column_id='" +
            h.name +
      ...
      return {
        ...
        isWorkTimeArguments: function() {
          ...
          return i instanceof a
            ? i
            : (((e = i.date
                ? new a(i.date, i.unit, i.task, null, i.calendar)
                : new a(
                    arguments[0],
                    arguments[1],
                    arguments[2],
        ...
        getClosestWorkTimeArguments: function(e) {
          ...
          return n instanceof s
            ...
            : ((i = r.isDate(n)
                ? new s(n)
                : new s(n.date, n.dir, n.unit, n.task, null, n.calendar)),
              n.id && (i.task = n),
              (i.dir = n.dir || "any"),
  ...
  function(t, e, i) {
    ...
    function r(t) {
      ...
      (a.start_date && a.end_date) ||
        ...
        (a.start_date = t.date[i + "_start"](a.start_date)),
        ...
        (a.end_date = t.date[i + "_start"](a.end_date)),
    ...
    (o.prototype = r.mixin(
      {
        ...
        _addItemInner: function(t, e) {
          ...
          var n =
            this.getIndexById(i) +
            Math.min(Math.max(e, 0), this.visibleOrder.length);
          1 * n !== n && (n = void 0),
        ...
        _changeIdInner: function(t, e) {
          ...
          for (var a = 0; a < i.length; a++)
            this.setParent(this.getItem(i[a]), e);
        ...
        getParent: function(t) {
          var e = null;
          return (e = void 0 !== t.id ? t : this.getItem(t))
            ? e[this.$parentProperty]
            : this.$getRootId();
        },
        clearAll: function() {
        ...
        eachParent: function(t, e) {
          for (var i = e, n = this.getParent(i); this.exists(n); )
            (i = this.getItem(n)), t.call(this, i), (n = this.getParent(i));
        },
  ...
  function(t, e) {
    t.exports = function(t) {
      function e(e, a) {
        if (!t._isAllowedUnscheduledTask(e)) {
          ...
          c == o.types.milestone && o.link_line_width > 1 && (h += 1),
            c == o.types.milestone &&
              ((s.left -= Math.round(d / 2)), (s.width = d));
          var u = document.createElement("div"),
            _ = Math.round(s.width);
          a.$config.item_attribute &&
            u.setAttribute(a.$config.item_attribute, e.id),
            o.show_progress &&
              c != o.types.milestone &&
              (function(e, i, n, r, a) {
                ...
                (l = Math.min(n, l)),
                  ...
                  r.rtl &&
                    ((o.style.position = "absolute"), (o.style.right = "0px"));
          ...
          var g = (function(e, i, n, r) {
            ...
            if (
              (t.getTaskType(l.type) == a.types.milestone
                ...
                : t.getTaskType(l.type) == a.types.project &&
                  s.push("gantt_project"),
              s.push("gantt_bar_" + t.getTaskType(l.type)),
              t.isSummaryTask(l) && s.push("gantt_dependent_task"),
              t.isSplitTask(l) && s.push("gantt_split_parent"),
            ...
            "gantt_task_line",
            l.task_class(e.start_date, e.end_date, e),
            e.id,
            a
          );
          (e.color || e.progressColor || e.textColor) &&
            (g += " gantt_task_inline_color"),
            (u.className = g);
          var p = [
            "left:" + s.left + "px",
            "top:" + (h + s.top) + "px",
            "height:" + d + "px",
            "line-height:" + Math.max(d < 30 ? d - 2 : d, 0) + "px",
            "width:" + _ + "px"
          ];
      ...
      function r(e, i, n, r, a) {
        var s,
          o = t.getState();
        +n.start_date >= +o.min_date &&
          ((s = r(
            [i, a.rtl ? "task_right" : "task_left", "task_start_date"].join(" ")
          )).setAttribute("data-bind-property", "start_date"),
          e.appendChild(s)),
          +n.end_date <= +o.max_date &&
            ((s = r(
              [i, a.rtl ? "task_left" : "task_right", "task_end_date"].join(" ")
      ...
      return {
        ...
        _linkToTaskStore: function() {
          if (this.$config.rowStore && this.$gantt.$data.tasksStore) {
            var t,
              e = this.$gantt.$data.tasksStore,
              i = this.$config.rowStore;
            e["_attached_" + i.name] ||
              ((e["_attached_" + i.name] = !0),
              e.attachEvent("onStoreUpdated", function(e, n, r) {
  ...
  function(t, e, i) {
    ...
    function l(t, e) {
      for (var i, n, r, a = 0, s = t.length - 1; a <= s; )
        if (((n = +t[(i = Math.floor((a + s) / 2))]), (r = +t[i - 1]), n < e))
          a = i + 1;
        else {
          if (!(n > e)) {
            for (; +t[i] == +t[i + 1]; ) i++;
    ...
    (o.prototype = {
          ...
          o && (s += " " + o),
            n.push(
              '<div class="' +
                ...
                t[a].height +
                'px">' +
                this._prepareScaleHtml(t[a], e, i) +
                "</div>"
            );
        }
        return n.join("");
      ...
      _prepareScaleHtml: function(t, e, i) {
        var n = this.$getConfig(),
          ...
          d = null;
        (t.template || t.date) &&
          (o = t.template || this.$gantt.date.date_to_str(t.date));
        var c = 0,
          h = t.count;
        !n.smart_scales ||
          isNaN(e) ||
          isNaN(i) ||
          ((c = l(t.left, e)), (h = l(t.left, i) + 1)),
          (d = t.css || function() {}),
        ...
        for (var u = c; u < h && t.trace_x[u]; u++) {
          ...
          if (f) {
            (v =
              ...
              g +
              "px;" +
              (n.smart_scales ? "position:absolute;left:" + p + "px" : "")),
              (y =
                "gantt_scale_cell" +
            ...
            var k =
              ...
              y +
              "'" +
              this.$gantt._waiAria.getTimelineCellAttr(_) +
              " style='" +
              v +
              "'>" +
              _ +
      ...
      dateFromPos: function(t) {
        ...
        var s = 0;
        return (
          a && (s = this._getColumnDuration(e, e.trace_x[i])),
        ...
        if (this.$config.rowStore) {
          ...
          if (e.getParent && e.exists(t) && e.exists(e.getParent(t))) {
            ...
            if (this.$gantt.isSplitTask(i))
              return e.getIndexById(i.id) * this.$getConfig().row_height;
          }
        ...
        return (
          ...
          (e.prototype._resizeScrollbars = function(t, e) {
            ...
            for (l = 0; l < r.length; l++)
              r[l].$config.group && (d[r[l].$config.group] = !0);
            for (l = 0; l < a.length; l++)
              (i = a[l]).$config.group && d[i.$config.group] && s(i);
            return n;
          }),
          ...
          (e.prototype.resize = function(e) {
            ...
            if (
              ...
              var n = [];
              n = (n = (n = n.concat(this.getCellsByType("viewCell"))).concat(
          ...
          (e.prototype.getContentSize = function(t) {
            ...
            return (
              (r += (n = this._getBorderSizes()).horizontal),
              (a += n.vertical),
              this.$root && ((r += 1), (a += 1)),
              {
                width: r,
            ...
            for (s = 0; s < this.$cells.length; s++)
              if (!(n = this.$cells[s]).$config.hidden) {
                ...
                var u = void 0,
                  _ = void 0;
                this._xLayout
                  ? ((u = this._calcSize(r.width, r, !0)), (_ = i - 2 * a))
                  : ((u = e - 2 * a), (_ = this._calcSize(r.height, r, !1))),
                  n.setSize(u, _);
              }
          }),
          e
      ...
      return {
        ...
        detachAll: function() {
          for (var t = 0; t < r.length; t++)
            i(r[t].element, r[t].event, r[t].callback, r[t].capture),
  ...
  function(t, e) {
    t.exports = function(t) {
      ...
      for (
        ...
        window.dhtmlx[n[a]] || (r.push(n[a]), (dhtmlx[n[a]] = i(n[a])));
      ...
      (t.assert = i(33)(t)),
        ...
        (t.render = function() {
          ...
          this._getHorizontalScrollbar() &&
            (n =
              this._getHorizontalScrollbar().$config.codeScrollLeft || n || 0);
          var r = null;
          if (
  ...
  function(t, e) {
    t.exports = function(t) {
      ...
      t._touch_events = function(n, r, a) {
        for (
          var s, o = 0, l = !1, d = !1, c = null, h = null, u = null, _ = 0;
          _ < i.length;
          _++
        )
          t.eventRemove(i[_][0], i[_][1], i[_][2]);
        (i = []).push([
          t.$container,
          n[0],
          function(i) {
            ...
            if (!a(i) && l) {
              ...
              if (!t._prevent_touch_scroll) {
                if (u && c) {
                  ...
                  if (
                    (!d &&
                      (Math.abs(_) > 5 || Math.abs(g) > 5) &&
                      ((t._touch_scroll_active = d = !0),
                      (o = 0),
                      (s = t.getScrollState())),
                    d)
                  ) {
                    ...
                    if ((s.x != p.x && g > 2 * _) || (s.y != p.y && _ > 2 * g))
                      return f(i);
                  }
                }
                return f(i);
            ...
            function(i) {
              if (!a(i))
                if (i.touches && i.touches.length > 1) l = !1;
                  ...
                  (c = r(i)),
                    t._locate_css(c, "gantt_hor_scroll") ||
                      t._locate_css(c, "gantt_ver_scroll") ||
                      (l = !0);
                  var n = e();
                  h = setTimeout(function() {
                    ...
                    n &&
                      e &&
                      !t._locate_css(c, "gantt_link_control") &&
                      !t._locate_css(c, "gantt_grid_data") &&
                      (n.on_mouse_down(c),
                      n.drag &&
                        n.drag.start_drag &&
                        (!(function(e) {
                          ...
                          if (n && t.isTaskVisible(e))
                            for (var r = 0; r < i.length; r++)
                              if (
                                (n = i[r].rendered[e]) &&
                                n.getAttribute(t.config.task_attribute) &&
                                n.getAttribute(t.config.task_attribute) == e
                              ) {
                                var a = n.cloneNode(!0);
                                (u = n),
                                  (i[r].rendered[e] = a),
            ...
            function(i) {
              if (!a(i)) {
                ...
                if (
                  (s && s.on_mouse_up(n),
                  u &&
                    (t.refreshTask(t.locate(u)),
                    u.parentNode &&
                      (u.parentNode.removeChild(u), t._touch_feedback())),
                  (t._touch_scroll_active = l = d = !1),
                  (u = null),
                  c && o)
                ) {
                  var _ = new Date();
                  if (_ - o < 500)
                    t.$services.getService("mouseEvents").onDoubleClick(c),
                      f(i);
                  else o = _;
                } else o = new Date();
              }
  ...
  function(t, e) {
    function i(t, e) {
      ...
      for (r = 0; r < o.length; r++) {
        ...
        "add" == l.name &&
          (l.width || (l.width = 44),
          (e.defined(l.min_width) && e.defined(l.max_width)) ||
            ((l.min_width = l.min_width || l.width),
          ...
          l.width &&
            ((l.width = +l.width),
            (l.width =
              l.min_width && l.min_width > l.width ? l.min_width : l.width),
            (l.width =
              l.max_width && l.max_width < l.width ? l.max_width : l.width)));
      }
      s.config.task_height &&
        (e.config.task_height = s.config.task_height || "full"),
        s._lightbox_template && (e._lightbox_template = s._lightbox_template),
        s._redefine_lightbox_buttons &&
          ((e.config.buttons_right =
            s._redefine_lightbox_buttons.buttons_right),
          (e.config.buttons_left = s._redefine_lightbox_buttons.buttons_left)),
        e.resetLightbox();
    }
    t.exports = function(t) {
      t.resetSkin ||
    ...
    t.exports = function(t) {
      ...
      return (
        ...
        (r.prototype.set_value = function(e, i, n, r) {
          ...
          (g[0].onclick = t.bind(function() {
            ...
            (f.onkeydown = t.bind(function(e) {
              var i;
              return (i =
                (e = e || window.event).charCode || e.keyCode || e.which) ==
                t.constants.KEY_CODES.DOWN
                ? (y(-1 * t.config.duration_step), !1)
                : i == t.constants.KEY_CODES.UP
                  ? (y(1 * t.config.duration_step), !1)
                  : void window.setTimeout(m, 1);
            }, this)),
            (f.onchange = t.bind(m, this)),
            "string" == typeof (o = t._resolve_default_mapping(r)) &&
              (o = {
                start_date: o
              }),
        ...
        (r.prototype.get_value = function(e, i, n) {
          ...
          return "string" == typeof t._resolve_default_mapping(n)
            ? r
            : {
                start_date: r,
                end_date: l,
        ...
        (r.prototype.set_value = function(t, e, i, n) {
          ...
          n.options &&
            ...
            (r =
              ...
              t.querySelector(
                "input[type=radio][value='" + n.default_value + "']"
              )) &&
            (!t._dhx_onchange &&
              n.onchange &&
              ((t.onchange = n.onchange), (t._dhx_onchange = !0)),
            (r.checked = !0));
        }),
      ...
      return (
        ...
        (r.prototype.render = function(e) {
          ...
          return (
            (n += i),
            e.single_date
              ? ((i = t.form_blocks.getTimePicker.call(this, e, !0)),
                (n += "<span></span>"))
              : (n +=
        ...
        (r.prototype.get_value = function(e, i, n) {
          ...
          return (
            (r = l(a, s, o)),
            "string" == typeof t._resolve_default_mapping(n)
              ? r
              : {
                  start_date: r,
                  end_date: (function(e, i, n, r) {
                    ...
                    return a <= r
                      ? t.date.add(r, t._get_timepicker_step(), "minute")
                      : a;
                  })(a, s, o, r)
                }
          );
    ...
    t.exports = function(t) {
      ...
      function u(e, i) {
        ...
        for (r = 0; r < e.length; r++)
          (n = t.config._migrate_buttons[e[r]]
            ? t.config._migrate_buttons[e[r]]
            : e[r]),
            (a +=
              "<div " +
              t._waiAria.lightboxButtonAttrString(n) +
      ...
      function _(e, i, n) {
        ...
        switch (n.timeFormat[i]) {
          case "%Y":
            for (
              e._time_format_order[2] = i,
                e._time_format_order.size++,
                e.year_range &&
                  (isNaN(e.year_range)
                    ? e.year_range.push &&
                      ((s = e.year_range[0]), (o = e.year_range[1]))
                    : (r = e.year_range)),
                r = r || 10,
                a = a || Math.floor(r / 2),
                s = s || n.date.getFullYear() - a,
                o = o || s + r,
                l = s;
              l < o;
              l++
            )
              c += "<option value='" + l + "'>" + l + "</option>";
            break;
          case "%m":
            for (
              e._time_format_order[1] = i, e._time_format_order.size++, l = 0;
              l < 12;
              l++
            )
              c +=
                ...
                l +
                "'>" +
                t.locale.date.month_full[l] +
                "</option>";
            break;
          case "%d":
            for (
              e._time_format_order[0] = i, e._time_format_order.size++, l = 1;
              l < 32;
              l++
            )
              c += "<option value='" + l + "'>" + l + "</option>";
          ...
          case "%H:%i":
            for (
              ...
              (c +=
                ...
                l +
                "'>" +
                t.templates.time_picker(n.date) +
                "</option>"),
                e._time_values.push(l),
                n.date.setTime(
                  n.date.valueOf() + 60 * t._get_timepicker_step() * 1e3
                ),
                (l =
                  24 * (n.date.getDate() != d ? 1 : 0) * 60 +
                  60 * n.date.getHours() +
                  n.date.getMinutes());
        }
        return c;
        ...
        (t.getLightbox = function(e) {
          ...
          return (
            ...
            (this._lightbox && this.getLightboxType() == this.getTaskType(e)) ||
              ...
              (t.config.wide_form || n) && (s += " gantt_cal_light_wide"),
              n && ((t.config.wide_form = !0), (s += " gantt_cal_light_full")),
              (i.className = s),
              ...
              (function(e) {
                ...
                for (o = 0; o < e.length; o++)
                  (i = e[o]),
                    ...
                    i.id &&
                      r &&
                      ((n = r.querySelector("label")),
                      (a = r.nextSibling) &&
                        (s = a.querySelector("input, select, textarea")) &&
                        ((s.id = s.id || "input_" + t.uid()),
                        (i.inputId = s.id),
          ...
          if (this._lightbox) {
            ...
            (t.style.height = "0px"),
              ...
              (this._lightbox.style.height =
                t.scrollHeight + this.config.lightbox_additional_height + "px"),
              (t.style.height = t.scrollHeight + "px");
          }
        }),
          ...
          (t.lightbox_events = {}),
              ...
              if (n.getAttribute("data-dhx-button"))
                ...
                if (-1 != s.indexOf("gantt_custom_button"))
                  if (-1 != s.indexOf("gantt_custom_button_"))
                    for (
                      r = n.parentNode.getAttribute("data-index"), a = n;
                      a &&
                      -1 == e.getClassName(a).indexOf("gantt_cal_lsection");
                ...
                r &&
                  ((r *= 1),
                  t.form_blocks[o[1 * r].type].button_click(
                    r,
                    n,
                    a,
                    a.nextSibling
            ...
            this.event(t.getLightbox(), "click", function(i) {
              var n = (i = i || window.event).target ? i.target : i.srcElement,
                r = e.getClassName(n);
              return (
                r || ((n = n.previousSibling), (r = e.getClassName(n))),
                n &&
                  r &&
                  0 === r.indexOf("gantt_btn_set") &&
                  ((n = n.firstChild), (r = e.getClassName(n))),
                !(!n || !r) &&
                  (t.defined(t.lightbox_events[n.className])
                    ? t.lightbox_events[n.className]
                    : t.lightbox_events.default)(i, n)
              );
            }),
        ...
        (t.form_blocks = {
              ...
              d = {
                ...
                timeFormat: (function(e) {
                  ...
                  (a = ["%d", "%m", "%Y"]),
                    ...
                    n.getSecondsInUnit(r) < n.getSecondsInUnit("day") &&
                      a.push("%H:%i");
                  return a;
                })(e)
              };
            for (
              e._time_format_order = {
                ...
                t.config.limit_time_select &&
                  ((d.first = 60 * l.first_hour),
                  (d.last = 60 * l.last_hour + 1),
                  d.date.setHours(l.first_hour)),
                r = 0;
              r < d.timeFormat.length;
              r++
            )
              r > 0 && (o += " "),
                (a = _(e, r, d)) &&
                  ((s = t._waiAria.lightboxSelectAttrString(d.timeFormat[r])),
                  (o +=
                    "<select " +
          ...
          _fill_lightbox_select: function(e, i, n, r) {
            if (
              ...
              a =
                Math.round(a / t._get_timepicker_step()) *
    ...
    t.exports = function(t) {
      (t.isUnscheduledTask = function(t) {
        ...
        (t.isTaskVisible = function(e) {
          ...
          var i = this.getTask(e),
            n = (this.getTaskType(i.type),
            i.start_date ? i.start_date.valueOf() : null),
        ...
        (t.createTask = function(e, i, n) {
          ...
          i) && (this.setParent(e, i, !0), (this.getTask(i).$open = !0));
        ...
        (t.roundDate = function(e) {
          ...
          if (
            ...
            (s = Math.floor(t.columnIndexByDate(o))),
            ...
            for (
              s = Math.floor(t.columnIndexByDate(o)),
                r = t.date[d + "_start"](new Date(i.min_date)),
                i.trace_x[s] && (r = t.date[d + "_start"](i.trace_x[s]));
              +r < +o;

            ) {
              var c = (r = t.date[d + "_start"](
                t.date.add(r, l, d)
              )).getTimezoneOffset();
    ...
    (a.prototype = {
      ...
      _getWorkUnitsBetweenGeneric: function(t, e, i, n) {
        ...
        for (var _ = !1; a.valueOf() < s.valueOf(); )
          (_ = (c = this._nextDate(a, i, n)).valueOf() > s.valueOf()),
  ...
  function(t, e, i) {
    ...
    (s.prototype = {
      ...
      _getDayHoursForMultiple: function(t, e) {
        for (
          var i = [],
            n = !0,
            r = 0,
            a = this.$gantt.date.day_start(new Date(e)),
            s = 0;
          s < 24;
          s++
        )
      ...
      createCalendar: function(t) {
        ...
        return (
          n.mixin(o, s), o._tryChangeCalendarSettings(function() {}) ? o : null
        );
      },
        ...
        (t.xml = {
          ...
          _getCollections: function(e) {
            for (
              ...
              for (
                var a = (i[n[r].getAttribute("for")] = []),
                  s = t.ajax.xpath(".//item", n[r]),
                  o = 0;
                o < s.length;
                o++
              ) {
                for (
                  var l = s[o].attributes,
                    d = {
          ...
          serialize: function() {
            ...
            for (r = 0, a = n.links.length; r < a; r++)
        ...
        (t.oldxml = {
          parse: function(e, i) {
            ...
            for (s = 0; s < a.length; s++) {
              ((l = t.xml._xmlNodeToJSON(a[s], !0)).id = "project-" + l.id),
                r.push(l);
            }
            for (s = 0; s < r.length; s++) {
              var l;
              ((l = r[s]).start_date = l.startdate || l.est),
      ...
      for (var s in ((t._waiAria = {
        ...
        _taskCommonAttr: function(e, i) {
          e.start_date &&
            ...
            (i.setAttribute(
              "aria-label",
              n(t.templates.tooltip_text(e.start_date, e.end_date, e))
            ),
            t.isReadonly(e) && i.setAttribute("aria-readonly", !0),
            e.$dataprocessor_class && i.setAttribute("aria-busy", !0),
            i.setAttribute(
              "aria-selected",
              t.getState().selected_task == e.id ||
              (t.isSelectedTask && t.isSelectedTask(e.id))
                ? "true"
                : "false"
            ));
        },
        ...
        linkAttr: function(e, i) {
          var r = t.config.links,
            ...
            o =
              ...
              " " +
              t.templates.drag_link(e.source, s, e.target, a);
    ...
    t.exports = function(t) {
      i(67)(t),
        (n.prototype.getGridColumns = function() {
          for (
            var t = this.$getConfig().columns, e = [], i = 0;
            i < t.length;
            i++
          )
            t[i].hide || e.push(t[i]);
      ...
      (t.$data.tasksStore.hasChild = function(i) {
        ...
        t.attachEvent("onTaskOpened", function(e) {
          if (
            ...
            var i = t._load_url,
              n =
                (i = i.replace(/(\?|&)?parent_id=.+&?/, "")).indexOf("?") >= 0
                  ? "&"
                  : "?",
              r = t.getScrollState().y || 0;
            t.load(
              i + n + "parent_id=" + encodeURIComponent(e),
              this._load_type,
              function() {
                r && t.scrollTo(null, r);
              }
  ...
  function(t, e) {
    t.exports = function(t) {
      ...
      function s(e) {
        ...
        ((a == n.task && r == n.project) || (a == n.project && r == n.task)) &&
          ((i.type = r), t.updateTask(e));
      }
    ...
    t.exports = function(t) {
      ...
      function i() {
        ...
        i &&
          ...
          ((i._silencedPlaceholder = !0),
          i.attachEvent(
            "onBeforeUpdate",
            e(function(e, n, r) {
              return (
                r.type != t.config.types.placeholder ||
                (i.setUpdated(e, !1), !1)
              );
            })
          ));
      ...
      function r(e) {
        var i = t.getTask(e);
        i.type == t.config.types.placeholder &&
          (i.start_date && i.end_date && i.unscheduled && (i.unscheduled = !1),
          t.batchUpdate(function() {
            var e = t.copy(i);
            t.silent(function() {
              t.deleteTask(i.id);
  ...
  function(t, e) {
    function i(t) {
      ...
      function n(i, n) {
        for (var r, a = n.join("_") + "_" + i, s = {}, o = 0; o < n.length; o++)
          s[n[o]] = !0;
        return (
          e[a]
            ? (r = e[a])
      ...
      function r(n, r, a, s) {
        ...
        return e[o]
          ? e[o]
          : (e[o] = (function(e, n, r, a) {
              for (
                var s = i(e, n), o = r.unit, l = {}, d = 0;
                d < s.length;
                d++
              )
                for (
                  var c = s[d],
                    h = t.date[o + "_start"](new Date(c.start_date));
                  h < c.end_date;
              ...
              for (
                var f, g, p = [], v = a.$getConfig(), d = 0;
                d < r.trace_x.length;
                d++
              )
                (f = new Date(r.trace_x[d])),
                  (g = t.date.add(f, 1, o)),
                  ((s = l[f.valueOf()] || []).length ||
                    v.resource_render_empty_cells) &&
                    p.push({
                      start_date: f,
                      end_date: g,
                      tasks: s
        ...
        }),
        {
          renderLine: function(t, e) {
            for (
              var i = e.$getConfig(),
                n = e.$getTemplates(),
                a = r(i.resource_property, t.id, e.getScale(), e),
                s = [],
                o = 0;
              o < a.length;
              o++
            ...
            var _ = null;
            if (s.length)
              for (_ = document.createElement("div"), o = 0; o < s.length; o++)
                _.appendChild(s[o]);
            return _;
          },
          filterTasks: i
      ...
      var e = (function(t) {
        return {
          ...
          getByWBSCode: function(e) {
            for (
              var i = e.split("."), n = t.config.root_id, r = 0;
              r < i.length;
              r++
            ) {
      ...
      return (
        ...
        function(t, e) {
          if (i) s(t);
            ...
            var r,
              o = this._dp && "off" != this._dp.updateMode;
  ...
  function(t, e, i) {
    ...
    t.exports = function(t) {
      ...
      function f(t) {
        t
          ? (_(!0), d.started || ((d.x = c.x), (d.y = c.y), (d.started = !0)))
          : (s && (clearInterval(s), (s = null)), _(!1), (d.started = !1));
      }
  ...
  function(t, e, i) {
    t.exports = function(t) {
      for (
        var e = [i(77), i(76), i(75), i(74), i(73), i(72), i(71), i(70)], n = 0;
        n < e.length;
        n++
      )
        e[n] && e[n](t);
    ...
    t.exports = function(t) {
      ...
      (t._dp_init = function(o) {
        t.assert(
          ...
          function(t, i) {
            (i.setGanttMode = function(t) {
              ...
              (i.afterUpdate = function() {
                ...
                (n =
                  "REST" != this._tMode
                    ? -1 != r.indexOf("gantt_mode=links")
                      ? "links"
                      : "tasks"
                    : r.indexOf("/link") > r.indexOf("/task")
                      ? "links"
                      : "tasks"),
                  i.setGanttMode(n);
              ...
              (i._getRowData = t.bind(function(e, n) {
                ...
                return (
                  d.$no_start && ((a.start_date = ""), (a.duration = "")),
                ...
                this.attachEvent("onAfterTaskDelete", function(i, r) {
                  if ((e.setGanttMode("tasks"), !n(i))) {
                    if (t.config.cascade_delete && a[i]) {
                      ...
                      for (var l in (e.setGanttMode("links"), o.links))
                        n(l) || e.setUpdated(l, !0, "deleted");
                      (a[i] = null),
                        "off" != s && e.sendAllData(),
                        e.setGanttMode("tasks"),
            ...
            s.push(
              ...
              e.attachEvent("onAfterUpdateFinish", function() {
                (o || l) &&
                  ...
                  o
                    ? t._dp.setGanttMode("tasks")
                    : t._dp.setGanttMode("links"));
              }),
          ...
          o.attachEvent("onDestroy", function() {
            !(function(t, i) {
              delete i.$gantt,
      ...
      bindDataStore: function(t, e) {
        ...
        i.attachEvent("onStoreUpdated", function(s, o, l) {
          if (!a(e)) {
            ...
            d &&
              (s && "move" != l && "delete" != l
                ? (i.callEvent("onBeforeRefreshItem", [o.id]),
                  n(o.id, d),
                  i.callEvent("onAfterRefreshItem", [o.id]))
                : (i.callEvent("onBeforeRefreshAll", []),
                  r(d),
        ...
        }),
        {
          select: function(t) {
            if (t) {
              ...
              this.unselect(),
                (e = t),
                this._skip_refresh ||
                  (this.refresh(t), this.callEvent("onAfterSelect", [t]));
            }
            return e;
          },
          ...
          unselect: function(t) {
            (t = t || e) &&
              ((e = null),
              this._skip_refresh ||
                (this.refresh(t), this.callEvent("onAfterUnselect", [t])));
          }
        }
      );
    };
  ...
  function(t, e, i) {
    ...
    t.exports = function() {
      return {
        ...
        getChildren: function(t) {
          return this.hasChild(t)
            ? this.$data.tasksStore.getChildren(t).slice()
            : [];
        },
        hasChild: function(t) {
      ...
      return {
        ...
        refreshTask: function(t, e) {
          ...
          if (i && this.isTaskVisible(t)) {
            ...
            gantt.isTaskExists(t) &&
              gantt.isTaskExists(gantt.getParent(t)) &&
              gantt.refreshTask(gantt.getParent(t));
        },
    ...
    t.exports = function(t) {
      ...
      var s = t.createDatastore({
          ...
          initItem: n.bind(function(e) {
            this.defined(e.id) || (e.id = this.uid()),
              ...
              e.end_date &&
                (e.end_date = t.date.parseDate(e.end_date, "xml_date"));
            var i = null;
            return (
              (e.duration || 0 === e.duration) &&
                (e.duration = i = 1 * e.duration),
              i &&
      ...
      function l(e) {
        ...
        if (!i && t.isTaskExists(e)) {
          ...
          t.isTaskExists(n) &&
            t.isTaskVisible(n) &&
            ((n = t.getTask(n)), t.isSplitTask(n) && (i = !0));
        }
        return i;
      }
      ...
      function h() {
        for (
          var e = null, i = t.$data.tasksStore.getItems(), n = 0, r = i.length;
          n < r;
          n++
        )
          ((e = i[n]).$source = []), (e.$target = []);
      ...
      s.attachEvent("onBeforeRefreshAll", function() {
        ...
        s.attachEvent("onAfterUpdate", function(e) {
          t._update_parents(e);
          for (var i = s.getItem(e), n = 0; n < i.$source.length; n++)
            o.refresh(i.$source[n]);
        ...
        s.attachEvent("onStoreUpdated", function(e, i, n) {
          if (
            ...
            if (t.config.fit_tasks && "paint" !== n) {
              ...
              a(t);
              var s = t.getState();
              if (+r.min_date != +s.min_date || +r.max_date != +s.max_date)
                return t.render(), t.callEvent("onScaleAdjusted", []), !0;
            }
            ...
            t.attachEvent("onAfterTaskDelete", function(e, i) {
              n[e] &&
                t.$data.linksStore.silent(function() {
                  for (var i in n[e])
                    t.$data.linksStore.removeItem(i), c(n[e][i]);
                  n[e] = null;
                });
            });
        })(),
        ...
        function _(i, n, r, a, s) {
          ...
          var d =
            (function(t) {
              ...
              : 0;
          return (
            (r = r || 0), a.rtl && (r *= -1), (l.x += (n ? -1 : 1) * r - d), l
          );
        }
          ...
          u.attachEvent(
            ...
            e.bind(function(s, o) {
              ...
              var h = !!n.locateClassName(o, "gantt_link_control"),
                ...
                k = !0;
              if (
                (h && ((k = !n.locateClassName(o, "task_end_date")), (h = !!y)),
                (r = y),
                (i = h),
                (a = k),
                h)
              ...
              var S = !(v == h && g == y && m == k);
              return (
                S && (g && e.refreshTask(g, !1), y && e.refreshTask(y, !1)),
                S && f(d.marker),
                (function(i, n, r, a) {
                  var s = (function() {
                      u._direction ||
                        ((u._direction = document.createElement("div")),
                        t.$task_links.appendChild(u._direction));
                      return u._direction;
                    })(),
                    o = l(),
                  ...
                  2 == p(i, r, n, a)
                    ? (_ += Math.PI)
                    : 3 == p(i, r, n, a) && (_ -= Math.PI);
                  var f = Math.sin(_),
                    g = Math.cos(_),
                    v = Math.round(n),
                    m = Math.round(i),
                    y = [
                      "-webkit-transform: rotate(" + _ + "rad)",
                      "-moz-transform: rotate(" + _ + "rad)",
                      "-ms-transform: rotate(" + _ + "rad)",
                      "-o-transform: rotate(" + _ + "rad)",
                      "transform: rotate(" + _ + "rad)",
          ...
          u.attachEvent(
            ...
            e.bind(function() {
              ...
              g(),
                ...
                u._direction &&
                  (u._direction.parentNode &&
                    u._direction.parentNode.removeChild(u._direction),
                  (u._direction = null));
            }, this)
          );
      };
              ...
              (t = (function(t, e) {
                ...
                return {
                  ...
                  _resize: function(i, n, r) {
                    ...
                    r.left
                      ...
                      : ((i.end_date = e.dateFromPos(s.end + n)),
                        i.end_date ||
                          (i.end_date = new Date(e.getState().max_date))),
                  ...
                  _drag_task_coords: function(t, i) {
                    return {
                      start: (i.obj_s_x =
                        i.obj_s_x || e.posFromDate(t.start_date)),
                    ...
                    if (a.mode) {
                      ...
                      if (this._handlers[a.mode]) {
                        if (
                          ...
                          a.mode == s.drag_mode.move
                        ) {
                          var h = {};
                          h[a.id] = r.copy(a);
                          var u = this._find_max_shift(
                            r.mixin(h, this.dragMultiple),
                            d
                          );
                          for (var _ in (void 0 !== u && (d = u),
                          this._update_item_on_move(d, a.id, a.mode, a, i),
                          this.dragMultiple)) {
                  ...
                  on_mouse_down: function(i, r) {
                    if (2 != i.button || void 0 === i.button) {
                      ...
                      if (
                        ...
                        if (!l || !d)
                          return r.parentNode
                            ? this.on_mouse_down(i, r.parentNode)
                            : void 0;
                        if (d)
                          if (
                            d.mode &&
                            d.mode != a.drag_mode.ignore &&
                            a["drag_" + d.mode]
                          ) {
                            if (
                              ((s = e.locate(r)),
                  ...
                  _finalize_mouse_up: function(t, i, n, r) {
                    ...
                    if (
                      ...
                      this.clear_drag_state(),
                        t == n.id &&
                          ((n.obj._dhx_changed = !1), e.mixin(a, n.obj, !0)),
                        e.refreshTask(a.id);
                  },
        ...
        if (e.$config.bind && t.getDatastore(e.$config.bind)) {
          ...
          t.defined(e.$getConfig().dnd_sensitivity) &&
            ...
            (r.lastTaskOfLevel = function(t) {
              for (
                var e = null, i = s().getItems(), n = 0, r = i.length;
                n < r;
                n++
              )
                i[n].$level == t && (e = i[n]);
            ...
            (r._getTaskByY = t.bind(function(t, i) {
              ...
              return (a = i < a ? a - 1 : a) > r.countVisible() - 1
                ? null
                : r.getIdByIndex(a);
            }, t)),
            r.attachEvent(
              ...
              t.bind(function(t, i) {
                ...
                function u(t, e) {
                  return (
                    !l.isChildOf(_.id, e.id) &&
                    (t.$level == e.$level || o.order_branch_free)
                  );
                }
                if (
                  (l.exists(h) ||
                    ((h = r.lastTaskOfLevel(
                      o.order_branch_free ? d.$level : 0
                    )) == r.config.id &&
                      (h = null)),
                  l.exists(h))
                ) {
                  var _ = l.getItem(h);
                  if (
                    l.getIndexById(_.id) * o.row_height + o.row_height / 2 <
                    c
                  ) {
                    ...
                    if (p) {
                      if (p.id == d.id)
                        return o.order_branch_free &&
                          l.isChildOf(d.id, _.id) &&
                          1 == l.getChildren(_.id).length
                          ? void l.move(
                              d.id,
                              l.getBranchIndex(_.id) + 1,
                              l.getParent(_.id)
                            )
                          : void 0;
                      _ = p;
                      ...
                      ((g = l.getIdByIndex(f)),
                      u((p = l.getItem(g)), d) && p.id != d.id)
                    )
                      return void l.move(d.id, -1, l.getParent(p.id));
                  } else if (o.order_branch_free && _.id != d.id && u(_, d)) {
                    if (!l.hasChild(_.id))
                      return (_.$open = !0), void l.move(d.id, -1, _.id);
                    if (l.getIndexById(_.id) || o.row_height / 3 < c) return;
                  }
                  f = l.getIndexById(_.id);
                  for (
                    var v = l.getIdByIndex(f - 1), m = l.getItem(v), y = 1;
                    (!m || m.id == _.id) && f - y >= 0;

                  )
                    (v = l.getIdByIndex(f - y)), (m = l.getItem(v)), y++;
                  if (d.id == _.id) return;
                  u(_, d) && d.id != _.id
                    ? l.move(d.id, 0, 0, _.id)
                    : _.$level != d.$level - 1 || l.getChildren(_.id).length
                      ? m &&
                        u(m, d) &&
                        d.id != m.id &&
                        l.move(d.id, -1, l.getParent(m.id))
                      : l.move(d.id, 0, _.id);
                }
                return !0;
              }, t)
              ...
              t.bind(function() {
                ...
                (e.$transparent = !1),
                  ...
                  this.callEvent("onBeforeRowDragEnd", [
                    ...
                    ? (t.move(r.config.id, r.config.index, r.config.parent),
                      (e.$drop_target = null))
              ...
              this._mouseDelegates.delegate(
                ...
                e.bind(function(i, n, r) {
                  if (!t.$getConfig().readonly)
                    return this.createTask({}, n || e.config.root_id), !1;
                }, e),
                t.$grid
              );
          },
      ...
      return function(e, i) {
        ...
        for (var l = [], d = 0; d < r.length; d++) {
          ...
          "add" == f.name
            ? ((h =
                "<div " +
                (y = t._waiAria.gridAddButtonAttrString(f)) +
                " class='gantt_add'></div>"),
              (u = ""))
            : ((h = f.template ? f.template(e) : e[f.name]),
          ...
          if (f.tree) {
            ...
            o.hasChild(e.id) && !t.isSplitTask(e)
              ? (p.push(s.grid_open(e)), p.push(s.grid_folder(e)))
              : (p.push(s.grid_blank(e)), p.push(s.grid_file(e)));
          }
        ...
        if (
          ((g = t.getGlobalTaskIndex(e.id) % 2 == 0 ? "" : " odd"),
          (g += e.$transparent ? " gantt_transparent" : ""),
          (g += e.$dataprocessor_class ? " " + e.$dataprocessor_class : ""),
          s.grid_row_class)
        ) {
        ...
        return (
          ...
          a.smart_rendering &&
            ...
            (b.style.left = "0px"),
            (b.style.top = i.getItemTop(e.id) + "px")),
          i.$config.item_attribute &&
            b.setAttribute(i.$config.item_attribute, e.id),
        ...
        i = {
          ...
          get_points: function(i, n) {
            ...
            if (c.from_start && c.to_start)
              ...
              if (((h = r.e_x > r.x + 2 * d), this.point_to(l.right, d), h))
      ...
      return function(n, r) {
        ...
        u && (h += " " + u),
          a.highlight_critical_path &&
            t.isCriticalLink &&
            t.isCriticalLink(n) &&
            (h += " gantt_critical_link"),
          (c.className = h),
          r.$config.link_attribute &&
            c.setAttribute(r.$config.link_attribute, n.id);
        ...
        return (
          n.color && (p.style.borderColor = n.color),
          c.appendChild(p),
    ...
    t.exports = function(t) {
      ...
      return function(i, n) {
        if (t.isSplitTask(i)) {
          ...
          for (
            var r = document.createElement("div"),
              a = t.getTaskPosition(i),
              s = t.getChildren(i.id),
              o = 0;
            o < s.length;
            o++
          ) {
          ...
          o.prototype,
          {
            show: function(e, i, n, o) {
              ...
              var l =
                ...
                a(n.min || t.getState().min_date) +
                "' max='" +
                a(n.max || t.getState().max_date) +
                "' name='" +
                i.name +
                "'></div>";
              o.innerHTML = l;
        ...
        a.attachEvent("onBeforeFocus", function(e) {
          ...
          a.attachEvent("onFocus", function(e) {
            ...
            return (
              clearTimeout(r),
              !n ||
                (n.id == a.id && n.columnName == a.columnName) ||
                (i.isVisible() && i.save()),
              !0
            );
          }),
          ...
          n.attachEvent("onTaskClick", function(e, i) {
            ...
            return (
              !a ||
              !t.getEditorConfig(a.columnName) ||
              ((t.isVisible() &&
                r.id == a.id &&
                r.columnName == a.columnName) ||
                t.startEdit(a.id, a.columnName),
              !1)
            );
          }),
          ...
          a.attachEvent("onKeyDown", function(e, r) {
            ...
            switch (c) {
              case d.ENTER:
                t.isVisible()
                  ? (t.save(), r.preventDefault(), (h = !0))
                  : o &&
                    !(r.ctrlKey || r.metaKey || r.shiftKey) &&
                    (i.startEdit(s.id, s.columnName),
                    r.preventDefault(),
                    (h = !0));
                break;
              case d.ESC:
              ...
              case d.DELETE:
                o &&
                  !t.isVisible() &&
                  (i.startEdit(s.id, s.columnName), (h = !0));
                break;
              case d.TAB:
                if (t.isVisible()) {
              ...
              default:
                t.isVisible()
                  ...
                  : ((c >= 48 && c <= 57) ||
                    ...
                    o &&
                    !t.isVisible() &&
                    (i.show(s.id, s.columnName), i.setValue(), (h = !0));
            }
            return !h;
          });
      },
      ...
      init: function(t, e) {
        ...
        i.attachEvent("onTaskClick", function(e, n) {
          ...
          return (
            !a ||
            !t.getEditorConfig(a.columnName) ||
            ((t.isVisible() && r.id == a.id && r.columnName == a.columnName) ||
              t.startEdit(a.id, a.columnName),
            !1)
          );
        }),
      ...
      var i = {
        ...
        column_drag_move: t.bind(function(i, r, a) {
          ...
          if ((u < _ && (u = _), s.keep_grid_width)) {
            var m = 0;
            for (v = d + 1; v < l.length; v++)
              l[v].min_width
                ? (f -= l[v].min_width)
                : s.min_grid_column_width && (f -= s.min_grid_column_width),
                l[v].max_width && !1 !== m ? (m += l[v].max_width) : (m = !1);
            m && (_ = e.$grid_data.offsetWidth - m),
              u < _ && (u = _),
              u > f && (u = f);
            ...
            y + k > t.$container.offsetWidth &&
              (u = t.$container.offsetWidth - k);
          }
          return (
            (o.left = u - 1),
            (p = Math.abs(u - g)),
            c.max_width && p > c.max_width && (p = c.max_width),
            s.rtl && (g = h.width - g + 2 - p),
            (o.marker.style.top = h.y + "px"),
            (o.marker.style.left = h.x - 1 + g + "px"),
            (o.marker.style.width = p + "px"),
            e.callEvent("onColumnResize", [d, l[d], p - 1]),
            !0
          );
        }, t),
        column_drag_end: t.bind(function(i, n, r) {
          ...
          if (
            ...
            !1 !== e.callEvent("onColumnResizeEnd", [l, d, h]) && d.width != h)
          ) {
        ...
        function l(t, e, i) {
          ...
          return (
            (function(t, e, i, n, a, s) {
              ...
              for (
                var d = 1 * s.rightBorderWidth,
                  c = r(s.rightBorderColor),
                  h = 0,
                  u = 0,
                  _ = 0,
                  f = 1;
                  ...
                  for (var _ = 0; _ < d.length; _++) {
                    ...
                    if (
                      ...
                      for (
                        ...
                        var y = Math.min(g, v);
                        (g -= v),
                          ((a = document.createElement("div")).style.height =
                            y + "px"),
                  ...
                  (function(t, e, i) {
                    ...
                    if (u) {
                      var m = (function() {
                        ...
                        return (
                          t ||
                            (((t = document.createElement("style")).id = n),
                            document.body.appendChild(t)),
                          t
                        );
                      })();
                      ...
                      var n = getComputedStyle(i),
                        ...
                        a = {
                          ...
                          rightBorderWidth: r
                            ...
                            .replace("px", ""),
                          bottomBorderColor: n.getPropertyValue(
                            "border-bottom-color"
                          ),
                          rightBorderColor: r.getPropertyValue(
                            "border-right-color"
                          )
                        };
    ...
    t.exports = function(t) {
      ...
      return {
        ...
        adjustSize: function(t, e, i, n) {
          ...
          for (
            var r = n - i + 1, a = this.getSum(e, i, n), s = i;
            s <= n;
            s++
          ) {
        ...
        return (
          ...
          (e.prototype._getGroupResizePosition = function(t, e) {
            ...
            this._eachGroupItem(function(i) {
              ...
              this._xMode
                ? (n.x += i._behind.$config.width - this._behind.$config.width)
                : (n.y +=
            ...
            for (var s = 0; s < r.length; s++) {
              ...
              void 0 === n
                ? (n = r[s])
                : r[s].newBehindSide > n.newBehindSide && (n = r[s]);
            }
            return n;
          }),
          ...
          (e.prototype._setGravity = function(t) {
            ...
            "front" !== t && (this._front.$config.gravity = a),
              "behind" !== t && (this._behind.$config.gravity = s);
          }),
  ...
  function(t, e) {
    t.exports = function(t) {
      ...
      function r(r, a, s) {
        ...
        var o = a.filter;
        return (
          s && s.setAttribute(e.config().layer_attribute, !0),
          (n[r] = {
        ...
        createGroup: function(i, n, o) {
          var l = {
            ...
            _add: function(t) {
              ...
              for (
                var i = this.container(), s = this.tempCollection, o = 0;
                o < s.length;
                o++
              )
                if (
                  ...
                  this.container() ||
                    (t &&
                      t.container &&
                      a.isChildOf(t.container, document.body)))
                ) {
                  var l = t.container,
                    d = t.id,
                    c = t.topmost;
                ...
                t &&
                  ...
                  void 0 === t.filter
                    ...
                    : t.filter instanceof Array &&
                      (t.filter.push(o), (t.filter = s(t.filter))),
    ...
    var n = (function(t) {
      return function(e) {
        ...
        function a(t) {
          ...
          return (
            a || (t.preventDefault ? t.preventDefault() : (t.returnValue = !1)),
            a
          );
        }
        ...
        function l(t) {
          ...
          var n = e.locate(t),
            ...
            a =
              ...
              e.callEvent("onTaskDblClick", [n, t]);
          if (a) {
            if (!o(r, t, n)) return;
            null !== n &&
              e.getTask(n) &&
        ...
        function h(t) {
          c.detachAll(),
            t &&
              (c.attach(t, "click", r),
              c.attach(t, "dblclick", l),
              c.attach(t, "mousemove", d),
              c.attach(t, "contextmenu", a));
        }
        return {
          reset: h,
          ...
          detach: function(t, e, n, r) {
            if (i[t] && i[t][e]) {
              for (var a = i[t], s = a[e], o = 0; o < s.length; o++)
                s[o].root == r && (s.splice(o, 1), o--);
              s.length || delete a[e];
            }
          },
          callHandler: function(t, e, n, r) {
            ...
            if (a)
              for (var s = 0; s < a.length; s++)
                ((n || a[s].root) && a[s].root !== n) ||
                  a[s].handler.apply(this, r);
          },
          onDoubleClick: l,
          onMouseMove: d,
          onContextMenu: a,
  ...
  function(t, e, i) {
    ...
    function a(t, e) {
      ...
      return i
        ? i instanceof r
          ? i
          : ((r.prototype = e), (this.$config[t] = new r(i)), this.$config[t])
        : e;
    }
    t.exports = function(t, e) {
      n.mixin(
    ...
    t.exports = {
      createFactory: function(t) {
        ...
        function a(a, s, o, l) {
          ...
          "resizer" != a ||
            o.mode ||
            (l.$config.cols ? (o.mode = "x") : (o.mode = "y")),
            "viewcell" != a ||
              "scrollbar" != o.view ||
              o.scroll ||
              (l.$config.cols ? (o.scroll = "y") : (o.scroll = "x")),
            (o = n.copy(o)).id || i[o.view] || (o.id = o.view),
            o.id && !o.css && (o.css = o.id + "_cell");
          var c = new d.create(s, o, this, t);
          return (
            d.configure && d.configure(c),
            r(c, l),
  ...
  function(t, e, i) {
    ...
    t.exports = function(t) {
        ...
        if (r) {
          ...
          if (v.keyboard) {
            if (13 == e || 32 == e) {
              ...
              p.getClassName(n).indexOf("gantt_popup_button") > -1 && n.click
                ? n.click()
                : (a(r, !0), (i = !0));
            }
            27 == e && (a(r, !1), (i = !0));
      ...
      function o(t) {
        o.cover ||
          ((o.cover = document.createElement("div")),
          (o.cover.onkeydown = s),
          (o.cover.className = "dhx_modal_cover"),
          document.body.appendChild(o.cover));
      ...
      function l(e, i, n) {
        ...
        return (
          ...
          ("gantt_" + a + "_button dhtmlx_" + a + "_button") +
          "' data-result='" +
          n +
          "' result='" +
          n +
      ...
      function c(i, c, h) {
        var u = i.tagName
          ...
          : (function(i, s, o) {
              ...
              var u = "";
              if (
                (i.width && (c.style.width = i.width),
                i.height && (c.style.height = i.height),
                i.title &&
                  (u +=
                ...
                s &&
                  (u += l(d(i.ok, t.locale.labels.message_ok, "OK"), "ok", !0)),
                o &&
                  (u += l(
                    d(i.cancel, t.locale.labels.message_cancel, "Cancel"),
                    "cancel",
                    !1
                  )),
                i.buttons)
          ...
          default:
            return (function(e) {
              v.area ||
                ...
                (v.area.className = "gantt_message_area dhtmlx_message_area"),
              ...
              return (
                ...
                "bottom" == v.position && v.area.firstChild
                  ? v.area.insertBefore(i, v.area.firstChild)
                  : v.area.appendChild(i),
                e.expire > 0 &&
                  (v.timers[e.id] = window.setTimeout(function() {
                    v.hide(e.id);
                  }, e.expire)),
                (v.pull[e.id] = i),
                (i = null),
      ...
      (v.seed = new Date().valueOf()),
        ...
        (v.hide = function(t) {
          ...
          e &&
            ...
            (e.className += " hidden"),
            v.timers[t] && window.clearTimeout(v.timers[t]),
            delete v.pull[t]);
        });
      var m = [];
      return (
        ...
        t.attachEvent("onAfterMessagePopup", function(t) {
          for (var e = 0; e < m.length; e++)
            m[e] === t && (m.splice(e, 1), e--);
        }),
        t.attachEvent("onDestroy", function() {
          o.cover &&
            o.cover.parentNode &&
            o.cover.parentNode.removeChild(o.cover);
          for (var t = 0; t < m.length; t++)
            m[t].parentNode && m[t].parentNode.removeChild(m[t]);
          (m = null),
            v.area &&
              v.area.parentNode &&
              v.area.parentNode.removeChild(v.area),
            (v = null);
        }),
        {
          alert: function() {
  ...
  function(t, e) {
    t.exports = function(t) {
      ...
      function i(i, n, r) {
        ...
        t.config[i] &&
          e[r] != a[i] &&
          ((n && s[r]) || ((s[r] = t.date.date_to_str(a[i])), (e[r] = a[i])));
      }
      return {
      ...
      var e = {
        init: function() {
          for (
            ...
            n[i[r]] = r;
          for (
            i = e.date.month_full, n = e.date.month_full_hash = {}, r = 0;
            r < i.length;
            r++
          )
            n[i[r]] = r;
            ...
            : ((t = t.replace(/^[\s]+/, "")),
              window.DOMParser && !n.isIE
                ...
                : window.ActiveXObject !== window.undefined &&
                  (((e = new window.ActiveXObject("Microsoft.XMLDOM")).async =
                    "false"),
                  e.loadXML(t)),
              e);
          var e;
  ...
  function(t, e, i) {
    i(15),
      (t.exports = function() {
        ...
        i(132)(t),
          (t.$services = t.$inject(i(131))),
          (t.config = t.$inject(i(130))),
          (t.ajax = i(129)(t)),
          (t.date = i(128)(t));
        var e = i(127)(t);
  ...
  function(t, e, i) {
    var n = {
      ...
      getGanttInstance: function() {
        for (var t = i(134)(), e = 0; e < n._ganttPlugin.length; e++)
          n._ganttPlugin[e](t);
        return (

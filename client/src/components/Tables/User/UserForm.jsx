...
class RegistrationForm extends React.Component {
  ...
  handleSubmit = e => {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        ...
        values.id = userId;
        fetch(window.ISD_BASE_URL + "users/updateUser", {
          method: "POST",
  ...
  fetchGroupUser() {
    fetch(window.ISD_BASE_URL + "qlpb/fetchPb", {
      headers: getTokenHeader()
    })
  ...
  render() {
    ...
    if (groupUser && groupUser.length) {
      phongBanOptions = groupUser.map(group => {
        return (
          <Option value={group.ma_pb} key={group.ma_pb}>
            {group.ma_pb} - {group.name}
          </Option>
        );
      });
    }
      ...
      <Form onSubmit={this.handleSubmit}>
        ...
        {!user.id ? (
          ...
          <React.Fragment>
            ...
            <FormItem {...formItemLayout} label="Nhập lại mật khẩu mới">
              {getFieldDecorator("confirm", {
                rules: [
                  {
                    required: false,
        ...
        <FormItem {...formItemLayout} label="Mã nhân sự">
        ...
        <FormItem {...formItemLayout} label="Điện thoại">

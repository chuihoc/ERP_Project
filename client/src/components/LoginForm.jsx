...
import { setAxiosAuthHeader } from 'ISD_API';
  ...
  handleSubmit (history, e) {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        this.getToken({...values}, history);
      }
    });
  }
  getToken(playload, history) {
    fetch(window.ISD_BASE_URL + 'token', {
      method: 'POST',
      headers: {
    ...
    return (
      <div className="login-wrapper">
        <div className="login-logo" >
          <img src="./images/logoANS.png"/>
        </div>
        <Route render={({ history }) => (
            <Form onSubmit={this.handleSubmit.bind(this, history)} className="login-form">
              <FormItem>
